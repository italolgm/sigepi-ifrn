...
object formularioEdicao extends BaseScalaTemplate[play.api.templates.Html,Format[play.api.templates.Html]](play.api.templates.HtmlFormat) with play.api.templates.Template3[Form[forms.AlterarUsuarioForm],Usuario,List[Campus],play.api.templates.Html] {
    ...
    /**/
    def apply/*1.2*/(formulario: Form[forms.AlterarUsuarioForm], professor: Usuario, campus: List[Campus]):play.api.templates.Html = {
...
<div class="row">
		<div class="span12">
			<div class="page-header" style="overflow:hidden;">
				<h1 style="float:left;">Edição do Professor: """),_display_(Seq[Any](/*13.51*/professor/*13.60*/.nome)),format.raw/*13.65*/("""</h1>
			</div>
			
			"""),_display_(Seq[Any](/*16.5*/helper/*16.11*/.form(action = routes.Professores.editar(professor.id), 'style -> "margin:0;")/*16.89*/{_display_(Seq[Any](format.raw/*16.90*/("""
			
			<div class="clearfix" id="idCurso_field">
					<label for="idCampus">Escolha o Campus do Professor:</label>
					<div class="input">
				...
				&nbsp;
				<a class="btn" href=""""),_display_(Seq[Any](/*36.27*/routes/*36.33*/.Professores.listaProfessores)),format.raw/*36.62*/("""" >Cancelar</a>
			""")))})),format.raw/*37.5*/("""
...
""")))})))}
    ...
    def render(formulario:Form[forms.AlterarUsuarioForm],professor:Usuario,campus:List[Campus]) = apply(formulario,professor,campus)
    
    def f:((Form[forms.AlterarUsuarioForm],Usuario,List[Campus]) => play.api.templates.Html) = (formulario,professor,campus) => apply(formulario,professor,campus)
    ...
    def ref = this
                ...
                /*
                    ...
                    SOURCE: C:/Users/Alessandro/workspace/sigepi-ifrn2/app/views/Professor/formularioEdicao.scala.html
                    HASH: aab5ad11f2f2507d7e06c8f0d6fd1f0af92bc6e0
