...
public class AvaliarProjetosActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		((TextView) findViewById(R.id.text_cabecalho)).setText(getString(R.string.label_buscar_projetos_avaliar));
	...
	private OnClickListener btBuscarOnClickListener = new OnClickListener() {
		public void onClick(View v) {
			if (!cpfBusca.getText().toString().equals("")) {
				Intent it = new Intent(AvaliarProjetosActivity.this, ListaProjetosAvaliarActivity.class);
...
/*	
	...
	*/
	...
	private void preencherCampos(ProjetoAvaliar c) {
		...
		exibirNome.setText(c.getProjetoAvaliar());
	}
	
	private ProjetoAvaliar montarObjetoConsulta(Bundle param) {
		ProjetoAvaliar consulta = new ProjetoAvaliar();

		consulta.setId(param.getInt(ProjetoAvaliar.ID)); // id da consulta no banco local
	
		consulta.setProjetoAvaliar(param.getString(ProjetoAvaliar.PROJETO_AVALIAR));
