...
public class MenuPrincipalAdapter extends BaseAdapter {
	...
	public MenuPrincipalAdapter(Activity context, boolean admin){
		this.context = context;
		this.admin = admin;
		this.menus = context.getResources().getStringArray(R.array.itens_menu_principal);
		this.icones = context.getResources().obtainTypedArray(R.array.icones_menu_principal);
	}
